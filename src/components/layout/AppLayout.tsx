    ...
    return (
      <>
        ...
        <div className={`border-b border-border flex items-center ${collapsed ? 'px-0 py-5 justify-center' : 'px-5 py-6'}`}>
          {collapsed ? (
            <img src="/novalogo.png" alt="Mr. Lion" className="w-8 h-8 rounded-lg object-contain" />
          ) : (
            <div className="flex items-center gap-2.5">
              <img src="/novalogo.png" alt="Mr. Lion" className="w-8 h-8 rounded-lg object-contain flex-shrink-0" />
              <span
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            <img src="/novalogo.png" alt="Mr. Lion" className="w-7 h-7 rounded-md object-contain flex-shrink-0" />
            <span
              className="text-base font-bold tracking-tight"
              style={{
                background: 'linear-gradient(135deg, hsl(42 65% 68%), hsl(42 60% 55%))',
