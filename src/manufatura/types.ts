...
export type TipoItem = 'materia_prima' | 'embalagem' | 'produto_acabado'
...
/** Receita / Bill of Materials de um produto acabado. */
export interface Receita {
  id: string
  produtoId: string                // → Item (tipo produto_acabado)
  nome: string
  rendimento: number               // unidades produzidas por execução (default 1)
